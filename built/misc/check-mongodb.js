"use strict";
Object.defineProperty(exports, "checkMongoDB", {
    enumerable: true,
    get: function() {
        return checkMongoDB;
    }
...
const requiredMongoDBVersion = [
    3,
    6
];
function checkMongoDB(config, logger) {
    return new Promise((res, rej)=>{
        ...
        (0, _mongodb.nativeDbConn)().then((db)=>{
            mongoDBLogger.succ('Connectivity confirmed');
            db.admin().serverInfo().then((x)=>{
                const version = x.version;
                mongoDBLogger.info(`Version: ${version}`);
                if ((0, _array.lessThan)(version.split('.').map((x)=>parseInt(x, 10)), requiredMongoDBVersion)) {
