...
_export(exports, {
    ...
    convertSchemaToOpenApiSchema: function() {
        return convertSchemaToOpenApiSchema;
    }
});
const schemas = {
    Error: {
    ...
    Note: {
        ...
        properties: {
            ...
            emojis: {
                ...
                example: [
                    {
                        name: 'local_custom_emoji',
                        url: 'xxx'
                    },
                    {
                        name: 'remote_custom_emoji@example.com',
                        url: 'xxx'
                    },
                    {
                        name: '@local_user',
                    ...
                    {
                        name: '@remote_user@example.com',
                        url: 'xxx'
                    },
                    {
                        name: 'local_custom_reaction@.',
                        url: 'xxx'
                    },
                    {
                        name: 'remote_custom_reaction@example.com',
                        url: 'xxx'
                    }
                ]
            },
...
function convertSchemaToOpenApiSchema(schema) {
    const res = schema;
