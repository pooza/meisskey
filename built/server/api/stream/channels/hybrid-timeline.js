...
let _class = class _class extends _channel.default {
    ...
    async onNewNote(note) {
        var _note_fileIds;
        if (!(note.user.host == null && note.visibility === 'public' || // local public
        (0, _oid.oidEquals)(note.userId, this.user._id) || // myself
    ...
    constructor(...args){
        super(...args);
        _define_property(this, "chName", 'hybridTimeline');
